...
public class ScienceDailyFeedMessage extends FeedMessage {
	static Logger logger = LoggerFactory.getLogger(ScienceDailyFeedMessage.class);

	public ScienceDailyFeedMessage(String source, SyndEntry entry) {
		super();
