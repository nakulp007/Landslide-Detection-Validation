...
public class StandardFeedMessage extends FeedMessage {
    static Logger logger = LoggerFactory.getLogger(StandardFeedMessage.class);

    public StandardFeedMessage(String source, SyndEntry entry) {
        super();
